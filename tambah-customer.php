...
if (isset($_POST['simpan'])) {
    ...
    $sql = "INSERT INTO customer (nama_customer, phone, addres) VALUES ('$nama','$phone','$addres')";
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE customer SET nama_customer='$nama', phone='$phone', addres='$addres' WHERE id='$id'");
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-12 mb-4">
                                                    ...
                                                    <input type="text" class="form-control" name="nama" id="" placeholder="Masukan Nama customer" value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_customer'] : '' ?>" required>
                                                </div>
                                                <div class="col-sm-12 mb-4">
                                                ...
                                                <div class="col-sm-12 mb-4">
                                                    ...
                                                    <input type="text" class="form-control" name="addres" id="" placeholder="Masukan Alamat" value="<?php echo isset($_GET['edit']) ? $rowEdit['addres'] : '' ?>" required>
                                                </div>
                                                <div class="col-sm-12">
